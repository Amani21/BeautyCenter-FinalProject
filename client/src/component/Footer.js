        ...
        <div className="container bottom_border">
          <div className="row">
            <div className=" col-sm-4 col-md col-sm-4  col-12 col">
              ...
              <p>
                <i className="fa fa-phone" /> +216 52 985 290
              </p>
              <p>
                <i className="fa fa fa-envelope" /> info@beautycenter.com
              </p>
            </div>
            ...
            <div className=" col-sm-4 col-md  col-12 col">
              ...
              <ul className="footer_ul2_amrc">
                <li>
                  <a href="#">
                    <i className="fab fa-chrome fleft padding-right" />{" "}
                  </a>
                  <p>
                    Beauty Center (Site Web)
                    <a href="#">https://www.lipsum.com/</a>
                  </p>
                </li>
                <li>
                  <a href="#">
                    <i className="fab fa-facebook-f fleft padding-right" />{" "}
                  </a>
                  <p>
                    Beauty Center(Page officielle)
                    <a href="#">https://www.lipsum.com/</a>
                  </p>
                </li>
              </ul>
